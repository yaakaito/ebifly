...
ebifly.result=function(a){this.socket.send(this.createLog(ebi.message.type.result,a))};ebifly.createLog=function(a,b){var c=ebi.createMessageObject();c.type=a;c.msg=b;c.origin=ebi.message.origin.client;return c};ebifly.executeScript=function(a){if(a.type==ebi.message.type.script)try{ebifly.result(eval(a.msg))}catch(b){ebifly.execption(b.message)}};(function(){ebifly.connect({host:"localhost",port:8080})})();
