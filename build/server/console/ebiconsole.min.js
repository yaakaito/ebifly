var ebiconsole={event:{},socket:null,message:{last:0},last:0,htmlModelObj:null};
...
ebiconsole.event.message=function(a){a.mt=ebiconsole.message.createTimeString(new Date);ebiconsole.message.last=+a.last;a.type=="LOG"?ebiconsole.insertLog(a):a.type=="RES"?ebiconsole.insertResult(a):a.type=="EXP"?ebiconsole.insertException(a):a.type=="HTM"&&ebiconsole.updateHTML(a)};ebiconsole.event.clickHTMLDetails=function(){};ebiconsole.message.createLog=function(a){var b=this.createBase();b.type="LOG";b.msg=a;return b};
