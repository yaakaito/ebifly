...
ebiconsole.selectNode=function(a){var a=a.split(","),b=1,c=a.length,d=this.htmlModelObj,e;if(c==1)return this.htmlModelObj;for(;b<c;b++)if(e=a[b],d.children.length>e)d=d.children[e];else return null;return d};
